...
function injectDemoButtonIfNeeded() {
  ...
  if (!document.getElementById("demoModeButton")) {
    ...
    demoButton.style.cssText =
      "position: fixed; bottom: 20px; right: 20px; z-index: 9999; background-color: #3DA5BD; " +
...
function showWelcomeMessage(tourName) {
  ...
  const modal = new bootstrap.Modal(
    document.getElementById("tourWelcomeModal"),
  );
  modal.show();

  // Clean up when the modal is hidden
  document
    .getElementById("tourWelcomeModal")
...
function showTourCompletionMessage() {
  ...
  // Show the modal
  const modal = new bootstrap.Modal(
    document.getElementById("tourCompletionModal"),
  );
  modal.show();

  // Clean up when the modal is hidden
  document
    .getElementById("tourCompletionModal")
    .addEventListener("hidden.bs.modal", function () {
      ...
      return [
        {
          ...
          content:
            "This table shows all agents currently registered in the system, their types, and statuses.",
          placement: "top",
        },
        {
          ...
          content:
            "Each row represents an agent with its ID, name, type, status, and available actions.",
          placement: "top",
        },
        {
          ...
          content:
            "This panel shows real-time performance metrics for each active agent in the system.",
          placement: "top",
        },
        {
          ...
          content:
            "Here you can see the most recent activities performed by the agents in the system.",
          placement: "left",
        },
        {
          ...
          title: "Agent Details",
          content:
            "Click this button to view detailed information about the agent, including its capabilities and status.",
          placement: "top",
        },
      ];
      ...
      return [
        {
          ...
          content:
            "This panel contains all the components you can use to build your workflow, including agents, connectors, and data sources.",
          placement: "right",
        },
        {
          ...
          content:
            "This meter shows the current complexity of your workflow, which affects performance and resource requirements.",
          placement: "bottom",
        },
        {
          ...
          content:
            "Drag and drop components from the left panel to this canvas to build your workflow. Connect components to create the process flow.",
          placement: "top",
        },
        {
          ...
          content:
            "When you select a component on the canvas, this panel displays its properties that you can modify.",
          placement: "top",
        },
        {
          ...
          content:
            "This panel provides detailed analysis of your workflow's complexity metrics to help you optimize it.",
          placement: "left",
        },
      ];
      ...
      return [
        {
          ...
          content:
            "Use this panel to select the agent you want to work with and configure its operating mode.",
          placement: "right",
        },
        {
          ...
          content:
            "Customize the agent's behavior by modifying these parameters in JSON format.",
          placement: "right",
        },
        {
          element: "#execute-btn",
          title: "Execute Agent",
          content:
            "Click this button to run the agent with the configured parameters.",
          placement: "right",
        },
        {
          ...
          title: "Agent Output",
          content:
            "This panel displays the real-time output from the agent execution, including system messages and results.",
          placement: "left",
        },
        {
          element: ".col-md-6:first .card-header",
          ...
          content:
            "The agent may generate visualizations of its analysis, which will appear in this panel.",
          placement: "top",
        },
        {
          ...
          content:
            "Use this action to compare the current forecast with previously saved forecasts.",
          placement: "left",
        },
      ];
      ...
      return [
        {
          ...
          content:
            "LevyMaster is an AI-powered financial calculation platform specialized in multi-component process (MCP) management.",
          placement: "bottom",
        },
        {
          element: ".navbar-nav",
          ...
          content:
            "Use this menu to navigate between different sections of the application, including the MCP framework.",
          placement: "bottom",
        },
        {
          ...
          content:
            "This area displays the content of the selected section. Try navigating to the MCP UI section to explore the advanced features.",
          placement: "top",
        },
      ];
  }
