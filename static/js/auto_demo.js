...
const demoScenarios = {
  ...
  "agent-registry": {
    ...
    description:
      "Experience how intelligent agents collaborate to process complex levy calculations",
    steps: [
      {
        action: "highlight",
  ...
  "workflow-designer": {
    ...
    description:
      "See how to create, test and optimize levy calculation workflows",
    steps: [
      {
        action: "highlight",
  ...
  "agent-playground": {
    ...
    description:
      "Test how the system handles real-world levy calculation scenarios",
    steps: [
      {
        action: "highlight",
  ...
  default: {
    ...
    description:
      "Experience the full capabilities of the LevyMaster Multi-Agent System",
    steps: [
      {
        action: "show-welcome",
...
function injectAutoDemoButton() {
  ...
  demoButton.style.cssText =
    "position: fixed; bottom: 20px; right: 20px; z-index: 9999; background-color: #FF5722; " +
...
function showDemoWelcomeModal(scenario) {
  ...
  const modal = new bootstrap.Modal(
    document.getElementById("demoWelcomeModal"),
  );
  modal.show();

  // Clean up when the modal is hidden
  document
    .getElementById("demoWelcomeModal")
...
function showDemoHUD(message) {
  ...
  animatedDot.style.cssText =
    "display: inline-block; width: 10px; height: 10px; background-color: #FF5722; " +
...
function highlightElement(selector, duration) {
  ...
  highlight.style.cssText =
    "position: absolute; z-index: 9998; background-color: rgba(255, 87, 34, 0.2); " +
...
function simulateClick(selector, duration) {
  ...
  setTimeout(function () {
    ...
    clickEffect.style.cssText =
      "position: absolute; z-index: 9999; width: 20px; height: 20px; " +
...
function simulateActivity(targetId, content, duration, callback) {
  ...
  if (!targetElement) {
    ...
    if (targetId === "activity-log") {
      ...
      const activitiesList = document.querySelector(
        ".card:nth-child(3) .list-group",
      );
      if (activitiesList) {
      ...
      alertDiv.innerHTML =
        '<i class="bi bi-check-circle-fill me-2"></i>' + content;
    ...
    console.error(
      "Target element not found and could not be created:",
      targetId,
    );
    return;
  }
...
function simulateDragAndDrop(
  ...
  setTimeout(function () {
    ...
    ghost.style.cssText =
      "position: absolute; z-index: 9999; background-color: rgba(33, 150, 243, 0.7); " +
    ...
    if (sourceElement.tagName === "LI") {
      ...
      ghost.innerHTML =
        '<i class="bi bi-box"></i> ' +
        (sourceElement.getAttribute("data-name") || "Component");
    }
...
function createWorkflowComponent(position, name) {
  ...
  component.style.cssText =
    "position: absolute; background-color: white; border: 1px solid #dee2e6; " +
...
function simulateReportGeneration(duration) {
  ...
  setTimeout(function () {
    ...
    setTimeout(function () {
      ...
      alert.style.cssText =
        "max-width: 400px; margin-left: auto; margin-right: auto; z-index: 9999;";
      alert.innerHTML = `
  ...
  return {
    ...
    datasets: [
      ...
      },
      {
        ...
        data: [1.22, 1.25, 1.28, 1.29, 1.3, 1.31],
        borderColor: "rgba(13, 110, 253, 0.3)",
        borderDash: [5, 5],
        pointRadius: 0,
        fill: false,
...
function showDemoCompletionModal() {
  ...
  // Show the modal
  const modal = new bootstrap.Modal(
    document.getElementById("demoCompletionModal"),
  );
  modal.show();

  // Clean up when the modal is hidden
  document
    .getElementById("demoCompletionModal")
    .addEventListener("hidden.bs.modal", function () {
