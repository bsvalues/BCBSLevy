  ...
  forms.forEach((form) => {
    form.addEventListener("submit", function (e) {
      ...
      if (form.checkValidity()) {
        ...
        const loadingText =
          form.getAttribute("data-loading-text") || "Processing your request";
...
function setupAjaxLoadingHandlers() {
  ...
  ajaxElements.forEach((element) => {
    ...
    const button =
      element.tagName === "BUTTON" ? element : element.querySelector("button");

    if (button) {
      button.addEventListener("click", function (e) {
        const loadingType =
          element.getAttribute("data-loading-type") || "default";
        const loadingText =
          element.getAttribute("data-loading-text") || "Loading data";
...
function initAutoLoadingElements() {
  const autoLoadElements = document.querySelectorAll(
    '[data-loading-auto="true"]',
  );
...
function createLoadingHTML(type, text) {
  ...
  switch (type) {
    case "dollar-bill":
      animationHTML =
        '<div class="loading-dollar-bill"><img src="/static/images/animations/dollar-bill.svg" alt="Loading"></div>';
      break;
    case "tax-calculator":
      animationHTML =
        '<div class="loading-tax-calculator"><img src="/static/images/animations/tax-calculator.svg" alt="Loading"></div>';
      break;
    case "property-tax":
      animationHTML =
        '<div class="loading-property-tax"><img src="/static/images/animations/property-tax.svg" alt="Loading"></div>';
      break;
    case "coins":
      animationHTML =
        '<div class="loading-coins"><img src="/static/images/animations/loading-coins.svg" alt="Loading"></div>';
      break;
    case "tax-form":
      animationHTML =
        '<div class="loading-tax-form"><img src="/static/images/animations/tax-form.svg" alt="Loading"></div>';
      break;
    default:
