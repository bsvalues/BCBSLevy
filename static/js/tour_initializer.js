    ...
    steps: [
      {
        ...
        intro:
          "Welcome to your dashboard! This is where you can see an overview of your tax districts, properties, and recent levy calculations.",
        position: "right",
      },
      {
        ...
        title: "Key Metrics",
        intro:
          "These cards show you the key metrics about your tax districts, such as total assessed value and levy amounts.",
        position: "bottom",
      },
      {
        ...
        intro:
          "Here you can see your recent activity, including imports, exports, and calculations.",
        position: "left",
      },
      {
        ...
        intro:
          "These charts provide visual representations of your tax data to help you identify trends and patterns.",
        position: "top",
      },
      {
        ...
        title: "Quick Actions",
        intro:
          "These buttons allow you to quickly access common actions like starting a new calculation or importing data.",
        position: "left",
      },
      {
        ...
        title: "Notifications",
        intro:
          "You'll receive important notifications here about compliance issues, upcoming deadlines, and system updates.",
        position: "bottom",
      },
    ],
  },
    ...
    steps: [
      {
        ...
        intro:
          "This is the levy calculator, where you can calculate property tax levies for different scenarios.",
        position: "bottom",
      },
      {
        ...
        intro:
          "Start by selecting the tax district you want to calculate levies for.",
        position: "right",
      },
      {
        ...
        intro:
          "Enter the required information such as year, assessed values, and rate adjustments.",
        position: "left",
      },
      {
        ...
        intro:
          "You can create different scenarios to compare various levy outcomes.",
        position: "top",
      },
      {
    ...
    steps: [
      {
        ...
        title: "Data Import",
        intro:
          "This page allows you to import tax district and property data into the system.",
        position: "bottom",
      },
      {
        element: ".file-upload",
        title: "File Upload",
        intro:
          "You can upload files in various formats including TXT, XLS, XLSX, and XML.",
        position: "right",
      },
      {
  ...
  property_search: {
    steps: [
      ...
      },
      {
        ...
        intro:
          "The search results will appear here, showing matching properties.",
        position: "top",
      },
      {
    ...
    steps: [
      {
        ...
        intro:
          "Welcome to the Admin Dashboard! Here you can manage all aspects of the Levy Calculation System.",
        position: "bottom",
      },
      {
        element: ".admin-users",
        ...
        intro:
          "Manage system users, including creating new accounts and setting permissions.",
        position: "right",
      },
      {
        ...
        intro:
          "Administer tax districts, including creation, deletion, and configuration.",
        position: "left",
      },
      {
        ...
        intro:
          "Configure system-wide settings such as default values, display options, and calculation parameters.",
        position: "top",
      },
      {
        element: ".admin-logs",
        title: "System Logs",
        intro:
          "Review system logs to monitor activity and troubleshoot issues.",
        position: "bottom",
      },
    ],
  },
    ...
    steps: [
      {
        ...
        intro:
          "Welcome to the Public Property Tax Lookup! This tool allows you to search for properties and view their tax information.",
        position: "bottom",
      },
      {
        element: ".lookup-form",
        title: "Search Form",
        intro:
          "Enter your property details here to find specific property tax information.",
        position: "right",
      },
      {
        ...
        intro:
          "Use these options to refine your search by district, year, or other criteria.",
        position: "top",
      },
      {
        ...
        intro:
          "Browse tax districts to find your property or view district-wide information.",
        position: "left",
      },
    ],
  },
    ...
    steps: [
      {
        ...
        intro:
          "Welcome to the Reports Dashboard! Here you can generate and view various reports about tax levies and properties.",
        position: "bottom",
      },
      {
        ...
        intro:
          "Choose from different report types such as district summaries, historical trends, and compliance reports.",
        position: "right",
      },
      {
        ...
        intro:
          "Customize your report by applying filters for specific time periods, districts, or properties.",
        position: "top",
      },
      {
        ...
        intro:
          "Download your report in various formats including PDF, Excel, or CSV for sharing and analysis.",
        position: "left",
      },
      {
        ...
        title: "Saved Reports",
        intro:
          "Access your previously generated reports or reports shared with you by other users.",
        position: "bottom",
      },
    ],
  },
    ...
    steps: [
      {
        ...
        intro:
          "Welcome to the Levy Calculation Tool! This powerful calculator helps you determine property tax levies for your districts.",
        position: "bottom",
      },
      {
        ...
        intro:
          "Select the tax district you want to calculate levies for from this dropdown menu.",
        position: "right",
      },
      {
        element: "#year-select",
      ...
      },
      {
        ...
        intro:
          "Enter the total assessed value for the district or leave blank to use the value from the database.",
        position: "top",
      },
      {
        ...
        intro:
          "Apply adjustments to the levy rate based on special circumstances or legal requirements.",
        position: "bottom",
      },
      {
        element: "#calculate-button",
        ...
        intro:
          "Click this button to calculate the levy based on your inputs and view the results.",
        position: "right",
      },
    ],
  },
    ...
    steps: [
      {
        ...
        intro:
          "Welcome to the Property Lookup Tool! This tool helps you find detailed information about properties in your district.",
        position: "bottom",
      },
      {
        ...
        title: "Search Form",
        intro:
          "Use this form to search for properties by address, PIN, or tax code.",
        position: "right",
      },
      {
        ...
        title: "Search Results",
        intro:
          "Your search results will appear here with property details and tax information.",
        position: "top",
      },
    ],
  },
    ...
    steps: [
      {
        ...
        intro:
          "Welcome to the Public Property Search! This tool allows the public to search for property tax information.",
        position: "bottom",
      },
      {
      ...
      },
      {
        ...
        title: "Results",
        intro:
          "Your search results will display here with public tax information.",
        position: "top",
      },
    ],
  },
    ...
    steps: [
      {
        ...
        intro:
          "Welcome to the Historical Analysis Tool! This powerful tool helps you analyze historical tax trends.",
        position: "bottom",
      },
      {
        ...
        intro:
          "Use these filters to focus your analysis on specific time periods, districts, or properties.",
        position: "right",
      },
      {
        ...
        intro:
          "These charts visualize historical trends to help identify patterns and anomalies.",
        position: "top",
      },
      {
        ...
        intro:
          "Export your analysis results in various formats for reporting and presentations.",
        position: "left",
      },
    ],
  },
    ...
    steps: [
      {
        ...
        intro:
          "Welcome to the Compliance Verification Tool! This tool helps ensure your tax calculations comply with all applicable laws and regulations.",
        position: "bottom",
      },
      {
        ...
        intro:
          "Run these automated checks to verify compliance with various requirements.",
        position: "right",
      },
      {
        ...
        intro:
          "Generate detailed compliance reports for auditing and documentation purposes.",
        position: "top",
      },
      {
        ...
        intro:
          "Review historical compliance data to track improvements over time.",
        position: "left",
      },
    ],
  },
...
function startTour(tourName) {
  ...
  intro.setOptions({
    ...
    exitOnOverlayClick:
      localStorage.getItem("exit_on_overlay_click") !== "false",
