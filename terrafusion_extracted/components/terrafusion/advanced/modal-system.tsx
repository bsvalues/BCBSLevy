      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-[#00e5ff]/10">
          <div>
            ...
            {description && (
              <p className="text-sm text-[#00e5ff]/70 mt-1">{description}</p>
            )}
          </div>

          <button
            onClick={onClose}
            className="text-[#00e5ff]/70 hover:text-[#00e5ff] transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        {/* Footer */}
        {footer && (
          <div className="p-4 border-t border-[#00e5ff]/10 flex justify-end gap-2">
            {footer}
          </div>
        )}
