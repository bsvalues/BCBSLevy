  ...
  return (
    <GlassmorphicContainer className={`overflow-hidden ${className}`}>
      <div className="p-6">
        ...
        {description && (
          <p className="text-sm text-[#00e5ff]/70 mb-4">{description}</p>
        )}

        <div className="space-y-6">
          <div>
            <h4 className="text-sm font-medium text-[#00e5ff]/70 mb-2">
              Headings
            </h4>
            <div className="space-y-4 bg-[#002a4a]/50 p-4 rounded-lg">
              <div>
                <h1 className="text-4xl font-bold text-white">Heading 1</h1>
                <p className="text-xs text-[#00e5ff]/50 mt-1">
                  text-4xl font-bold
                </p>
              </div>
              <div>
            ...
            <div className="space-y-4 bg-[#002a4a]/50 p-4 rounded-lg">
              <div>
                <p className="text-base text-white">
                  Base paragraph text. TerraFusion provides a comprehensive
                  design system with consistent typography, colors, and
                  components.
                </p>
              ...
              <div>
                <p className="text-sm text-white">
                  Small paragraph text. Use this for secondary information or
                  supporting content within your application.
                </p>
                <p className="text-xs text-[#00e5ff]/50 mt-1">text-sm</p>
              </div>
              <div>
                <p className="text-xs text-white">
                  Extra small text. Ideal for captions, footnotes, or metadata
            ...
            <div className="space-y-4 bg-[#002a4a]/50 p-4 rounded-lg">
              ...
              <div>
                <p className="font-medium text-white">
                  Medium weight text for subtitles
                </p>
