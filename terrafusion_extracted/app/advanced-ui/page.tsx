...
import {
  ...
  useNotifications,
} from "@/components/terrafusion/advanced/notification-system";
import {
  ModalProvider,
  useModal,
  useConfirmation,
} from "@/components/terrafusion/advanced/modal-system";
              ...
              <Button
                ...
                onClick={() => {
                  addNotification({
                    ...
                    message:
                      "Generating system performance report. This may take a moment.",
                    duration: 5000,
                  });
                }}
              >
            ...
            <Button
              ...
              onClick={() => {
                addNotification({
                  ...
                  message:
                    "The data has been successfully processed and saved.",
                  duration: 5000,
                });
              }}
            >
            ...
            <Button
              ...
              onClick={() => {
                addNotification({
                  ...
                  title: "Information",
                  message:
                    "Your system is currently processing a background task.",
                  duration: 5000,
                });
              }}
            >
